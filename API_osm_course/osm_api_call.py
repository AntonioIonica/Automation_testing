...
giving amenity, there is a report written and also the website of specified amenity is given in the console
"""
import json, time
...
def call_osm_api(amenity):
    ...
    :return: by giving different amenities, the websites and other info changes and is written in dublin_pub.json file
    """

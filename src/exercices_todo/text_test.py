...
try:
    with open('/exercices_todo/translate.txt', mode='r') as my_file:
        ...
        with open('C:/Users/anton/PycharmProjects/Automation_testing/src/exercices_todo/test-fr.txt', mode='w') as file_fr:

...
class HomePage(BasePage):
    AUTOCOMPLETE_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(5) > a')
    BUTTONS_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(6) > a')
    CHECKBOX_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(7) > a')
    DATEPICKER_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(8) > a')
    DRAG_AND_DROP_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(9) > a')
    DROPDOWN_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(10) > a')
    ...
    KEY_MOUSE_PRESS_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(12) > a')
    MODAL_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(13) > a')
    PAGE_SCROLL_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(14) > a')
    RADIO_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(15) > a')
    SWITCH_WINDOW_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(16) > a')
    COMPLETE_WEB_FORM_BTN = (By.CSS_SELECTOR, 'body > div > div > li:nth-child(17) > a')
    LOGO = (By.ID, 'logo')
